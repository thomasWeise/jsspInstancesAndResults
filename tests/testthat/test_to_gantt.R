...
test_that("Test the to-Gantt methods ft06", {
  ...
  expect_identical(g1, jssp.evaluate.gantt(g1$gantt, inst.id));
  ...
  expect_identical(g2, jssp.evaluate.gantt(g2$gantt, inst.id));
  ...
  expect_identical(g3, jssp.evaluate.gantt(g3$gantt, inst.id));
})
