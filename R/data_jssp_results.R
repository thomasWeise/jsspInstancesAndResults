...
#' \item{total.time.min}{the minimum value of the total consumed runtime of the run, i.e., the time until the run was terminated}
...
#' \item{total.time.med}{the median of the total consumed runtime of the run, i.e., the time until the run was terminated}
#' \item{total.time.mode}{the mode, i.e., the most frequent value, of the total consumed runtime of the run, i.e., the time until the run was terminated}
#' \item{total.time.max}{the maximum value of the total consumed runtime of the run, i.e., the time until the run was terminated}
...
#' \item{reach.best.f.min.time.mean}{the arithmetic mean of the time needed by the runs which discovered the best solution among all runs (best.f.min) until they reached said solution}
#' \item{budget.fes}{the maximum number of function evaluations a run was allowed to perform until forceful termination}
#' \item{budget.time}{the maximum time granted to a run until forceful termination}
#'}
#'
