...
- the OR Library format of all instances in the study [in a single file](https://raw.githubusercontent.com/thomasWeise/jsspInstancesAndResults/master/data-raw/instances-data/instance_data.txt), equivalent to loading `jssp.instance.data` in the `R` package
